  ...
  @keyframes animStar {
    ...
    pageonestyle = `
        ...
        .cycle {
            ...
            background: conic-gradient(#800200 , #e01010);
            filter: blur(350px);
            z-index: -1;
            display :none;
        }
    ...
    pagethreestyle = `
        ...
        .right-left-content{
                ...
                text-align :center;
                gap :10px;
                animation :aut 2s linear infinite;
    ...
    pageone = `
        ...
        <div class="content-gsp" >
            <div class="cycle"></div>
            <h1> <span class="title-firstpg">PingPong</span> to determine</h1>
            <h1>the galaxy's <span class="title-firstpg">future.</span></h1>
            <p>Lorem Ipsum is simply dummy text of the printing 
            and typesetting industry</p>
            <br>
            <button type="click" class="btn-firstpg" id="btn-firstpg" data-link >Get started</button>
        </div>
            <div class="img-gsp" >
                <img class="img-firstpg" src="/images/astro1.png" alt="">
                <div class="cycle-astro"></div>
            </div>
        </div>
    `;
    pagetwo = `
        <div class="page-2">
            <div class="astro-page-2" >
                <div class="astro-back" ></div>
                <div class="astro-white" ></div>
                <div class="left-white" ></div>
                <div class="right-white" ></div>
                <img src="/images/astro2.png" >
            </div>
            <div class="content-page-2" >
                <h1 class="title-firstpg" >PingPong</h1>
                <p class="para-1-page-2">
                    In a distant galaxy, peace hinges on 
                    the Grand Galactic Tournament of zero-gravity ping pong.
                </p>
                <p class="para-2-page-2">
                    In a distant galaxy, peace hinges on the Grand Galactic Tournament of zero-gravity ping pong. The Zephron Empire aims to dominate. 
                    As your planet's champion, outplay foes, uncover secrets, and secure freedom.
                    In a distant galaxy, peace hinges on the Grand Galactic Tournament of zero-gravity ping pong. The Zephron Empire aims to dominate. 
                    As your planet's champion, outplay foes, uncover secrets, and secure freedom.
                    In a distant galaxy, peace hinges on the Grand Galactic Tournament of zero-gravity ping pong. The Zephron Empire aims to dominate. 
                    As your planet's champion, outplay foes, uncover secrets, and secure freedom.
                </p>
                <button type="click" class="btn-firstpg" id="btn-firstpg" data-lin >Get started</button>
            </div>
        </div>
    `;
    pagethree = `
        <div class="page-3" id="page-03">
            <div class="animation-page-3" >
                <div class="right-anim content-layout" >
                    <div class="right-left-content right-anim-content-1" >
                        <h1>kawkab</h1>     
                        <img src="/images/kawakib/kawkab2.png">
                        <p>
                            Zero-gravity ping pong tournament decides the galaxy's fate.
                            Outplay opponents, uncover secrets, win peace
                        </p>
                    </div>
                    <div class="right-left-content right-anim-content-2" >
                        <h1>kawkab</h1>     
                        <img src="/images/kawakib/kawkab2.png">
                        <p>
                            Zero-gravity ping pong tournament decides the galaxy's fate.
                ...
                <div class="middle-anim" >
                    <div class="content-cycle" >
                        <h1>Stars of War</h1>
                        <div class="sep-text"></div>
                        <p>
                            In a distant galaxy, peace is kept by the Grand Galactic Tournament, 
                            where disputes are settled through zero-gravity ping pong. 
                            The Zephron Empire, led by Emperor Vortax, 
                            seeks to dominate the galaxy by undermining the tournament's integrity. 
                            As your homeworld’s champion, outplay formidable opponents, 
                            uncover Zephron’s secrets, and rally allies. 
                            Victory means freedom and peace; defeat spells doom. 
                            Will you rise to the challenge?
                        </p>
                    </div>
                    <div class="cycle-page-3">
                    </div>
                    <div class="cycletwo-page-3">
                    </div>
                    <div class="cycle-page-3 starts">
                    </div>
                </div>
                <div class="left-anim content-layout" >
                    <div class="right-left-content left-anim-content-1" >
                        <h1>kawkab</h1>    
                        <img src="/images/kawakib/kawkab2.png">
                        <p>
                            Zero-gravity ping pong tournament decides the galaxy's fate.
                    ...
                    <div class="right-left-content left-anim-content-2" >
                        <h1>kawkab</h1>    
                        <img src="/images/kawakib/kawkab2.png">
                        <p>
                            Zero-gravity ping pong tournament decides the galaxy's fate.
    ...
    rander(){
        ...
        ${this.pagethree}
        `;
        const sub = document.getElementById('btn-firstpg');
...
<div class="cycle-astro"></div>
<div>
    <img class="back-img" src="/images/back.png" alt="astro">
</div>
<div class="content-first-pg">
    <img class="img-firstpg" src="/images/astro1.png" alt="">
    <h1> <span class="title-firstpg">PingPong</span> to determine</h1>
    <h1>the galaxy's <span class="title-firstpg">future.</span></h1>
    <p>Lorem Ipsum is simply dummy text of the printing 
        and typesetting industry</p>
    <a href="/login"  type="submit" class="btn-firstpg" data-link >
        get started
    </a>
</div>
<div class="shadow-firstpg-1"></div> */}